...
with open('/Users/baka/Desktop/parsejson/structuredData.json', 'r') as f:
    CURRENT_PDF_JSON = json.load(f)

with open('/Users/baka/Downloads/errors_desc.json', 'r') as f:
    CURRENT_ERRORS_JSON = json.load(f)

with open('/Users/baka/Downloads/7.32-2017.json', 'r') as f:
